...
| modelId       | Query            | false    | String    | 资产所属模型ID。[如何获取modelId信息>>](/docs/api/zh_CN/2.0.9/api_faqs#modelid-modelid)                                                                                                                                                                                                                           |
...
| measurepoints | Query            | true     | String    | 资产测点，支持多测点查询，各个测点间用逗号隔开；支持查询的（设备数*测点数）上限为3000。[如何获取pointId信息>>](/docs/api/zh_CN/2.0.9/api_faqs#pointid-pointid)                                                                                                                                                                           |
...
| 名称  | 数据类型      | 描述               |
|-------|----------------|---------------------------|
| **items** | `List<Object>` | 资产数据列表。单设备单点的返回数据按时间升序排列。其中的Object结构体中存储着参数，详见[items](/docs/api/zh_CN/2.0.9/tsdb_service/get_asset_ai_raw_data.html#id3)。
...
```json
{
        ...
        "opentsdb_ai_point_xxx": "1.1236", 	 //测点的标识符与测点数据
...
```
https://{apigw-address}/tsdb-service/v2.0/ai?orgId=o15504722874071&modelId=&assetIds=4DXYH7nS&measurepoints=opentsdb_ai_point_xxx&startTime=2019-06-01%2010:00:00&endTime=2019-06-11%2023:00:00&pageSize=&accessKey=accessKey&withQuality=true
```
